...
with(household_power_consumption_data,plot(Date_time,Voltage,type='n'))
with(household_power_consumption_data,points(Date_time,Voltage,type='l'))
...
with(household_power_consumption_data,plot(Date_time,Global_reactive_power,type='n'))
with(household_power_consumption_data,points(Date_time,Global_reactive_power,type='l'))
#turnoff the image to capture the image.
dev.off()
